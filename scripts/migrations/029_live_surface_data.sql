...
INSERT INTO pellier.workshop_scenarios (
    ...
    ('anna', 2, 'Keep the gift under $100 and show me the strongest two options.', 'required', 'exercise', '28'),
    ('anna', 3, 'Which one should I choose, and prove it stayed in budget and in stock?', 'required', 'prove', NULL),
    ...
    ('theo', 2, 'What goes well with the pour-over set?', 'required', 'exercise', '34'),
