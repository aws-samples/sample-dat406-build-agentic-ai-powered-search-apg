...
export const AGENT_VOCABULARY: Record<AgentToolName, AgentToolEntry> = {
  'memory.recall': {
    ...
    agentTracePath: '/pellier-labs/proof-board#runtime-gateway-policy',
  },
  'memory.seed': {
    name: 'memory.seed',
  ...
  'inventory.live': {
    ...
    agentTracePath: '/pellier-labs/proof-board#marco-floor-check',
  },
  'inventory.watch': {
  ...
  'experience.return': {
    ...
    agentTracePath: '/pellier-labs/proof-board#audit-ledger',
  },
  'weather.lookup': {
    name: 'weather.lookup',
    label: 'Weather-aware',
...
const SKILL_VOCABULARY: Record<string, AgentToolEntry> = {
  'skill.packing-list': {
    ...
    agentTracePath: '/pellier-labs/skills',
  },
  'skill.gift-table': {
...
export function lookupVocab(name: string): AgentToolEntry {
  ...
  return {
    ...
    agentTracePath: '/pellier-labs/tools',
  }
}
