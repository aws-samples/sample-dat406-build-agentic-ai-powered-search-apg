...
| `espressoDark` | `#1F1410` | Pellier Labs sidebar background                    |
| `espressoMid`  | `#2A1E18` | Pellier Labs dark surface mid-tone                 |
...
| `expansionStack` | 1280px | Pellier Labs expansion area stacks from 3-col to 2+1 layout       | Full 3-column expansion area                                        |
...
- The `expansionStack` token (1280px) defines where Pellier Labs three-column expansion area transitions from 3 equal columns to a 2+1 stacked layout. This is separate from the `mobile` breakpoint.
