 ...
 * Pellier, Observatory). When each Observatory page explains itself differently,
 ...
 * order:
 *
 *   Try   — the exact Pellier query or action to perform.
...
const sectionStyle: React.CSSProperties = {
  padding: '12px 14px',
  borderLeft: '2px solid var(--obs-rule-2)',
  marginBottom: '10px',
};
