/**
 * Pellier Observatory — Shared UI Components
 *
 * Barrel export for all reusable primitives used across Observatory surfaces.
 *
 * Requirements: 22.3
 */
...
export { ObservatoryWelcome } from './ObservatoryWelcome';
