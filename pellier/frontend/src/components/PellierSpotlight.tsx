 ...
 * storefront. It explains the primary shopper path and keeps Pellier Labs
 * explicitly optional for the one-hour workshop.
 */
...
const STEPS: SpotlightStep[] = [
  ...
  {
    label: 'Inspect',
    eyebrow: 'Optional: Pellier Labs',
    headline: 'Trace the agent actions.',
    body: 'After a completed turn, open Labs to inspect routing, tool calls, retrieval, and Aurora evidence.',
