/**
 * DetailPageShell — the outer frame every Observatory architecture page shares.
 *
 ...
 *
 *   <DetailPageShell
 *     crumb={['Pellier Observatory', 'Architecture', 'Memory']}
...
import '../../styles/observatory-shared.css'
