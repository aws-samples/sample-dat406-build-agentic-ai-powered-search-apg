...
const SessionsList: React.FC = () => {
  ...
  const { data, loading, error, refetch } = useAgentTraceData<Session[]>({
    key: 'sessions',
  });
      ...
      <EditorialTitle
        ...
        summary={
          showingPersonaJourney
            ? 'Sessions opens on the signed-in persona so participants follow one coherent Pellier story. Each turn mirrors the Pellier pill text and expected skill/tool trace; instructor view reveals all recorded replays.'
