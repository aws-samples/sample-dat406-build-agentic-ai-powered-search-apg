  ...
  Dispatcher: [
    {
      ...
      description:
        'Dispatcher scores the utterance and hands the turn to one owning agent (Curator, Style Advisor, …). One hop per decision - the pattern Pellier runs in production.',
      status: 'complete',
      durationMs: 58,
      agent: 'Dispatcher',
    },
...
const RoutingPatternIntro: React.FC = () => (
  ...
  <ExpCard>
    ...
    <p style={{ ...introParagraphStyle, marginTop: '12px' }}>
      ...
      <strong style={{ color: 'var(--at-ink-1)' }}>Pellier</strong> uses in production:
