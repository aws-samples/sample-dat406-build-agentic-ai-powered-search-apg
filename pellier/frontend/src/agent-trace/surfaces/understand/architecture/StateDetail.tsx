...
const StateDetail: React.FC = () => {
  ...
  return (
    <DetailPageShell
      ...
      prose="The Pellier default path is dispatcher-first: services/chat.py triages small talk, classifies intent, optionally loads one persona skill, then hands the turn to one owning specialist/tool path. Agents-as-Tools and graph routing stay visible as teaching patterns, not the default storefront runtime."
      cheatSheet={[
        {
          numeral: 'i.',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            <StateKeyCard
              ...
              description="The owning specialist path for this turn. The Pellier default chooses one path, not a committee."
