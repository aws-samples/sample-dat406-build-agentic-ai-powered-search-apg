"""Regression test for Pellier writes to the local STM fallback."""
...
from services.chat import _append_pellier_stm_turn


def test_pellier_turn_writes_when_agentcore_memory_id_is_unset(monkeypatch) -> None:
