"""``/api/storefront/*`` — Pellier concierge briefing + pulse bar.

Two small GET endpoints power Pellier's ambient agent context:
...
async def _catalog_snapshot(db_service: Any) -> dict[str, Any]:
    ...
    try:
        ...
        # catalog schema. Approximate with the ``badge`` column (values like
