...
description: Create or revise Pellier shopper copy, editorial model prompts, runtime skill prose, outcome states, and Atelier explanations. Use when changing Boutique text, specialist voice, follow-up suggestions, policy or failure messages, VOICE.md, boutique_copy.py, or skills/*/SKILL.md.
---
...
1. Classify the surface:
   ...
   - Atelier copy is operational and may name architecture precisely.
...
- Preserve code and SQL typography when editing Atelier.
