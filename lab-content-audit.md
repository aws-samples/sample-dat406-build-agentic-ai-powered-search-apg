...
| `lab-content/builders/90-appendix/04-your-stack/index.en.md:26` | The "two-tier" model line refers to Opus/Sonnet, not memory — this is **fine**, keep it. | (no change) |
...
- [ ] `grep -rn "STM\|LTM" lab-content/` returns only intentional historical references (Opus/Sonnet two-tier in `90-appendix/04-your-stack/`).
